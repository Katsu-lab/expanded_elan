    ...
    */
     ...
     */
     public String getTabString(AnnotationCore annotationCore,
		...
		if (annotationCore instanceof EAFMultipleFileMatch) {
			String leftContext = ((EAFMultipleFileMatch) annotationCore).getLeftContext();
			sb.append(csvEncodeCond2(leftContext) + TAB);
				
			sb.append(csvEncodeCond2(annotationCore.getValue()) + TAB);
				
			String rightContext = ((EAFMultipleFileMatch) annotationCore).getRightContext();
			sb.append(csvEncodeCond2(rightContext) + NEWLINE);
