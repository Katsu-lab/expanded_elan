 ...
 * Derived from {@code CityInputMethod.java}.
 * 
...
//        luList.setFixedCellHeight(height);
     ...
     * @author Han Sloetjes
     */
	class CandidateRenderer extends JPanel implements ListCellRenderer<String> {
