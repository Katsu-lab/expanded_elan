...
public class ParamPanelContainer extends JPanel implements ParamPreferences {
	 ...
	 * @param host the recognizer host
	 * @param vm the Viewer Manager
	 * @param mode {@code Recognizer#AUDIO_TYPE} etc, the kind of recognizer this is.
	 */
	 ...
	 * Makes the layout.
	 * 
	 * @param addScrollPanes if {@code true} panels will be added embedded in
	 * scrollpanes
	 */
