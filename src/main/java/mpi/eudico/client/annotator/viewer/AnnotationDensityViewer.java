...
public class AnnotationDensityViewer extends AbstractViewer
    ...
    /** Enumeration type to specify the mode of the AnnotationDensityViewer */
    ...
    /**
     * Sets the {@code TierOrder} object containing the order of the tiers.
     * 
     * @param tierOrder the {@code TierOrder} object
     */
    ...
    /**
     * Returns the minimum size of the slider (the crosshair).
     *
    ...
    /**
     * Returns the preferred size of the slider (the crosshair).
     * 
    ...
    /**
     * This private method redraws all annotations on the AnnotationDensityViewer, based
     * on the viewMode and the keywords in {@code viewModeKeywords}.
     */
    ...
    /**
     * Updates the {@code all tiers} menu item, if it exists.
     */
    @Override
	...
	/**
	 * Notification that the tier set changed.
	 */
	@Override
	...
	/**
	 * Notification that the visibility of tier sets changed.
	 */
	@Override
