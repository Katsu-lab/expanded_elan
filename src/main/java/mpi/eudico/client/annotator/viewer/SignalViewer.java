...
public class SignalViewer extends TimeScaleBasedViewer
    ...
    private boolean loadTranscriptionMode = false;
...
//        }
    ...
    */
    ...
    /**
     * Returns the loadTranscriptionMode value
     * @return
     */
	public boolean isLoadTranscriptionMode() {
		return loadTranscriptionMode;
	}


	/**
	 * sets the loadTranscriptionMode boolean value
	 * @param loadTranscriptionMode
	 */
	public void setLoadTranscriptionMode(boolean loadTranscriptionMode) {
		this.loadTranscriptionMode = loadTranscriptionMode;
	}
