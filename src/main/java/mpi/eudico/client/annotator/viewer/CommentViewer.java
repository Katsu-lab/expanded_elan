...
/**
 * A viewer for comments on annotations, tiers and fragments.
 */
@SuppressWarnings("serial")
public class CommentViewer extends  AbstractViewer
	implements ACMEditListener,	ActionListener, ElanLocaleListener, 
	...
	/**
	 * Creates a new CommentViewer instance.
	 * 
...
//		rightPanel.add(menuBar, gbc);
	...
	/**
	 * Provides access to the {@code CommentManager}.
	 * 
	 * @return the {@code CommentManager}
	 */
	 ...
	 * @param viewColIndex the column index in the view
	 */
	 ...
	 * 
	 * @param modelRow row index in the model
	 */
	 ...
	 * @param caseSensitive if {@code true} the matching should take case into account
	 */
...
//				}
	 ...
	 * </ul>
	 * 
	 * @param existingIndex the index of an existing comment
	 * @param newCE the new comment
...
//		}
	 ...
	 * 
	 * @param existingIndex the row index of the existing comment
	 * @param ce the comment envelope
	 * @param reloadFromWhere the row index from which to reload
	 */
	 ...
	 * 
	 * @param source the editable source
