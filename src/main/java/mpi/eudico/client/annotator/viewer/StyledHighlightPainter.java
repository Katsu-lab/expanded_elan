...
/**
 * A class that adds some style options to the default text HighlightPainter.
...
public class StyledHighlightPainter extends DefaultHighlightPainter {
     ...
     * @param paintOffset the number of pixels to add to the size of the
     *        highlight
     * @param paintMode {@code FILLED} or {@code STROKED}
     */
     ...
     *
     * @return the shape that has been painted or {@code null}
     */
    @Override
     ...
     * Sets the paint mode.
     *
     * @param mode the new paint mode, either {@code FILLED} or {@code STROKED}
     */
