...
/**
 * A client for logging in to a comment web service and for uploading and 
 * downloading of comment envelopes. 
 */
public class CommentWebClient {
     ...
     * (Note: this doesn't really seem to be a singleton?)
     * 
     ...
     * 
     * @param <RES> the type of response object
     * @param uri the service URL
     * 
     ...
     * 
     * @param <RES> the type of the result object
     ...
     *
     * @param <ARG> the type of object to POST or PUT
     * @param <RES> the type of the result object
     * @param req the HTTP request object
     ...
     *
     * @param <ARG> the type of object to POST or PUT
     * @param <RES> the type of result object
     * @param req the HTTP request object
     ...
     * 
     * @param <ARG> the type of object to POST
     * @param <RES> the type of result object
     * @param uri the service URL
     * @param je the element to marshal
     * 
     ...
     * 
     * @param <ARG> the type of object to PUT
     * @param <RES> the type of result object
     * @param uri the service URL
     * @param je the element to marshal
     * 
