...
public class ShowHideMoreTiersDlg extends ClosableDialog
     ...
     * @param visibleTiers the currently visible tiers  (tiers or tier names)
     */
    public ShowHideMoreTiersDlg(Transcription trans, List<? extends Object>/*<String | TierImpl>*/ visibleTiers) {    	
     ...
     */
    public ShowHideMoreTiersDlg(Transcription trans, List<? extends Object>/*<String | TierImpl>*/ visibleTiers, Component component) {
     ...
     * @param visibleTiers the currently visible tiers (tiers or tier names)
     * @param component, the component used to set the location of the this dialog
     * @param rootTiersOnly show only root tiers in the table
     */
    public ShowHideMoreTiersDlg(Transcription trans, List<? extends Object>/*<String | TierImpl>*/ visibleTiers, 
    		Component component, boolean rootTiersOnly) {
     ...
     * @param component the component used to set the location of the this dialog
     */
    public ShowHideMoreTiersDlg(Transcription trans, List<String> tierOrder, 
    		List<? extends Object>/*<String | TierImpl>*/ visibleTiers, Component component) {
    ...
    private void initialize(List<String> tierOrder, List<? extends Object>/*<String | TierImpl>*/ visibleTiers){    	
    	if(tierOrder == null){    		
...
//    				break;
     ...
     * 
     * @param selectionMode sets the tab to activate
