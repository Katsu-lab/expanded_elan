 ...
 * with the same type or participant or to all depending tiers. 
 * 
 * @version 1.0
 * @author aarsom
 *
...
public class AdvancedAttributeSettingOptionDialog extends JDialog implements ActionListener, ChangeListener{
     ...
     */
	public AdvancedAttributeSettingOptionDialog(Dialog owner, String title, 
			TranscriptionImpl transcription, String tierName) {     
		super(owner, title, true);
     ...
     * @param tierName the name of the tier whose attributes have to be applied
     */
	public AdvancedAttributeSettingOptionDialog(Frame owner, String title,
			TranscriptionImpl transcription, String tierName) {     
		super(owner, title, true);
	...
	/**
	 * Applies the selected attributes to the selected tiers.
	 */
