...
/**
 * Abstract base class for a panel in which the user can select tiers and can 
 * have the tiers displayed sorted alphabetically. 
 */
...
public abstract class AbstractTierSortAndSelectPanel extends JPanel implements ActionListener,
	...
	/**
	 * An enumeration of tier modes determining which tiers will be available
	 * for sorting and selecting.
	 */
    public enum Modes {
     ...
     * @param selectedTiers the tiers to select
     */
...
//		}
    ...
    /** 
     * Sets and removes the hidden tiers from the selection. 
     ...
     * @param hiddenItems the items to deselect in that mode
     */
     ...
     * 
     * @param items the items to set selected
     */
     ...
     * 
     * @param items the items to set unselected
     */
     ...
     * 
     * @param rootsOnly if ({@code true} only root tiers are shown
     */
	 ...
	 *  
	 * @param rootsOnly if {@code true} only root tiers are shown, if 
	 * {@code false} all tiers are shown
	 */
	 ...
	 * 
	 * @param select if {@code true} all items are selected, otherwise all 
	 * items are set to unselected 
	 */
