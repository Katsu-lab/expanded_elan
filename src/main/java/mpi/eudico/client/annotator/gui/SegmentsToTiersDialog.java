...
/**
 * A dialog that allows the user to configure how segmentations are to be
...
public class SegmentsToTiersDialog extends ClosableDialog
    ...
    private JComboBox<String> allSegmentationsCombo;
    ...
    private void initComponents() {
        ...
        allSegmentationsCombo = new JComboBox<String>();
    ...
    private void extractSegmentations() {
        if ((segmentations != null) && (segmentations.size() > 0)) {
            ...
            allSegmentationsCombo.setModel(new DefaultComboBoxModel<String>(names));
            updateSegmentTable();
        }
    }

    /**
     * Extracts all unique segment labels and places them in a table with:
     * <ul>
     * <li>a checkbox to indicate whether or not this segment should be
     * converted to annotations</li>
     * <li>a textfield for an alternative label </li>
     * <li>a checkbox to indicate that the label should receive an index number
     * as a suffix</li>
     * </ul>
     */
    ...
    /**
     * This is the one tier / segmentation per operation conversion. The user
     ...
     */
    /**
     * Handling of changes in the row selection of the segmentations table.
     *
     * @param lse the event
     */
    @Override
