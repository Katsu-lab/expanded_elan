...
public class AboutPanel extends JPanel {
    ...
    public AboutPanel() {
        super();
        citeELAN = String.format("ELAN (Version %d.%d) [Computer software]. (2022). Nijmegen: Max Planck Institute for Psycholinguistics, The Language Archive. Retrieved from %s",
    ...
    private void initPanel() {
        ...
        textBuf.append("Copyright \u00A9 2001 - 2022");
        textBuf.append("<br>");
    ...
    private JPanel getSoftwarePanel(){
    	...
    	textBuf.append("<li><b>LibRow</b> http://www.librow.com</li><br>");
    	textBuf.append("<li><b>RosettaCode</b> https://rosettacode.org/wiki/Rosetta_Code</li>");
