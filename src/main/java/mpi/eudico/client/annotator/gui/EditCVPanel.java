...
public class EditCVPanel extends JPanel implements ActionListener,
    ...
    /**
     * Creates a panel without an initial CV and adds a button for additional
     * options.
     * 
    ...
    /**
     * For test purposes. 
     * Opens a frame with this panel and a test controlled vocabulary.
...
//    }
    ...
    */
     ...
     * It should do so right after calling makeLayout(), or at least before
     * setting a CV.
     * 
    ...
    */
    ...
    /**
     * A table model for the entries of a, possibly multilingual, CV. 
     * Cells are not editable in the table.
     */
