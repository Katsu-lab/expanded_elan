...
public class IGTCalculator {
	 ...
	 * 
	 * @param g2d the target graphics context
	 ...
	 * 
	 * @param currentNode the last child node on a particular depending tier
	 */
...
//	}
	 ...
	 * 
	 * @param tier the root IGTTier to wrap
	 * @param wrapIndex the index at which wrapping starts
	 */
	 ...
	 * 
	 * @param ann the main annotation
	 * @param xShift the number of pixels or units to shift the annotation
	 */
