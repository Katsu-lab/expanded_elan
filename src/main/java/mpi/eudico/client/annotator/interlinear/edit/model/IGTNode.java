...
/**
 * A node in an Interlinear Glossed Text tree structure.
 */
public interface IGTNode {
	 ...
	 * 
	 * @param igtTier the tier this annotation is part of
	 */
	 ...
	 * 
	 * @return a hash code based on the text of this node and of its children
	 */
	int hashCodeOfText();
