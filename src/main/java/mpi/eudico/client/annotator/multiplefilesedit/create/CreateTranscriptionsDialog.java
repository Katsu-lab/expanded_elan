...
/**
 * A dialog to configure the batch wise creation of eaf files for all media 
 * files in a domain.
 * 
 * @author Han Sloetjes
 */
...
//	private List<File> audioFolders;
	 ...
	 * @throws HeadlessException when used in a headless environment
	 */
	...
	/**
	 * Constructor with the parent frame and a modality flag.
	 * 
	 * @param owner the parent frame
