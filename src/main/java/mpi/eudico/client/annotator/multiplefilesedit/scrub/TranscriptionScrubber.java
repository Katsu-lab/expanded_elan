...
/**
 * A class that removes certain characters from annotations.
 * It can remove
 * <ul> 
 * <li>leading and/or trailing space characters
 * <li>sequences of multiple characters
 * <li>leading, trailing or all new line characters
 * <li>leading, trailing or all tabs characters
 * </ul>
 ...
 */
public class TranscriptionScrubber implements ProcessReporter {
     ...
     * anything changed) saves (overwrites) the file.
     *
