...
public class ModePanel extends JPanel implements ElanLocaleListener {
     ...
     * @param theMPC the main media player controller
     */
    ...
    /**
     * Sets the selected state of the loop mode checkbox.
     *
     * @param onOff the new selected state
     */
    ...
    /**
     * Sets the selected state of the selection mode checkbox.
     *
     * @param onOff if {@code true} the checkbox will be selected, otherwise
     * deselected
     */
     ...
     * 
     * @param mode id of the mode, {@code ELANCommandFactory#SELECTION_MODE} or
     * {@code ELANCommandFactory#LOOP_MODE}
    ...
    /**
     * Update texts for the input pane.
     */
    @Override
