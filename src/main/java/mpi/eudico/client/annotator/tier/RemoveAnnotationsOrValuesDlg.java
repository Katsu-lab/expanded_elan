...
/**
 * A dialog to remove all annotations or the annotations with specific values
 * from one or more tiers.
 * Alternatively, annotation values can be removed from all annotations or those
...
public class RemoveAnnotationsOrValuesDlg extends ClosableDialog implements ActionListener,
     ...
     *
     * @param transcription the transcription that holds the tiers
