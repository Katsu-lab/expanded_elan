...
public class CopyAnnotationsOfTierStep4 extends AbstractProgressStepPane {
	 ...
	 * <ul>
	 * <li>SelectedTiers  - {@code List<Object>} with tier names, should only contain one element</li>
	 * <li>OpenedFiles  - {@code List<String>} a list of selected files to process (in case of multiple file variant)</li>
