 ...
 * of its linguistic type and optional selection of the format of the
...
public class CalcOverlapsStep2 extends StepPane implements ListSelectionListener,
    ...
    /**
     * Adds a textfield for a new tier name, a list of valid linguistic types
...
//        contentCB.addActionListener(this);
    ...
    /**
     * Tier name and linguistic type have been set before.
     *
    ...
    /**
     * Checks whether the tier name field contains a valid tier name.
     *
    ...
    /**
     * Checks the tier name field and the type table and enables or disables
     * the Next button.
     */
