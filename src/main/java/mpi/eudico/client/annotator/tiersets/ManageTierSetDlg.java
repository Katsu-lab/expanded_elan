...
/**
 * A dialog for creating, modifying and deleting tier sets.
 * The window contains two main panels: one listing the tier sets (names), the
 * other showing attributes and tier names of the selected tier set.  
 * 
 * @see TierSet
 */
...
public class ManageTierSetDlg extends ClosableDialog implements ActionListener, ListSelectionListener{	
	 ...
	 * 
	 * @param frame the parent frame, possibly containing an opened transcription
	 */
	...
	/**
	 * Initializes the tier set panel.
	 */
	...
	/**
	 * Initialize the tier set button panel components.
	 */
	...
	/**
	 * Initializes the tier set attributes panel components.
	 */
	 ...
	 * @param model the table model to configure
	 */
   ...
   /**
    * Opens a dialog to create a new tier set.
    */
    ...
    */
	...
	/**
	 * Sets the tier sort and select panel to use.
	 * 
	 * @param tierSelectPanel the tier sort and select panel
	 */
	...
	/**
	 * Returns the tier sort and select panel.
	 * 
	 * @return the tier sort and select panel
	 */
