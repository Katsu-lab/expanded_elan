...
/**
 * A dialog to create new tier sets or change existing ones.
 *
...
public class EditTierSetDlg extends ClosableDialog implements ActionListener{	
	...
	/**
	 * Creates a new instance for adding new tier sets.
	 * 
	...
	/**
	 * Creates a new instance for modifying existing tier sets.
	 * 
	 * @param owner the owner dialog
	 * @param tierSet the tier set to modify
	 * @param title the title of the dialog
	 */
	...
	/**
	 * Initializes and returns the tier panel.
	 * 
	 * @return the panel
	 */
