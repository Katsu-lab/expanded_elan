...
public class TSRulerImpl implements TSRuler {
	...
	/**
	 * Creates a new TSRulerImpl instance with specified range.
	 * 
    ...
    /**
     * Returns the vertical position of the tick markers.
     * 
     * @return the y coordinates of tick marks
     */
     ...
     *
     * @param trackPanel the track panel to disconnect from
     */
