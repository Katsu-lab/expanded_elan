...
public class TSTrackPanelImpl implements TSTrackPanel {
     ...
     * @param intervalBeginTime the begin time of the interval
     */
     ...
     *
     * @return the current vertical zoom level
     */
     ...
     *
     * @see mpi.eudico.client.annotator.timeseries.TSTrackPanel#addTrack(AbstractTSTrack)
     */
    @Override
    ...
    /**
     * @see mpi.eudico.client.annotator.timeseries.TSTrackPanel#setMargin(Insets)
     */
    @Override
