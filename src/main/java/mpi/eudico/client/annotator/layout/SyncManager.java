...
public class SyncManager implements ActionListener, ItemListener, ChangeListener, ModeLayoutManager {
     ...
     *
     * @param object the media player or other component to add
     */
    @Override
    ...
    /**
     * Removes a media player or other component.
     *
     * @param object the media player to remove 
     */
    @Override
   ...
   private void resetOffsets() {
     ...
     * 
     * @param elanPlayer the player to make the focused player
     */
    private void setFocusedPlayer(ElanMediaPlayer elanPlayer) {
		...
		viewerManager.disableConnectedMediaPlayers();
    ...
    /**
     * Removes players and controller elements from the container.
     */
	@Override
	...
	/**
	 * Creates and/or adds players, viewer-players and controllers.
	 */
	@Override
	...
	/**
	 * Enables and disables many tier and annotation related actions that are
	 * not relevant for this mode.
	 * 
	 */
	@Override
    ...
    /**
     * Called before closing the synchronization mode, stores a few preferences.
     */
	@Override
