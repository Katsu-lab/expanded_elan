...
public class TranscriptionManager implements ModeLayoutManager, ActionListener {
	...
	private void setSignalViewer(SignalViewer sigViewer){
		...
		signalViewer.setLoadTranscriptionMode(true);
	...
	public void clearLayout() {		
		...
		viewerManager.destroyViewerByName(ELANCommandFactory.TRANSCRIPTION_VIEWER);
...
//			}					
	...
	public void isClosing() {	
		...
		if(signalViewer != null){	
			...
			signalViewer.setLoadTranscriptionMode(false);
		}		
