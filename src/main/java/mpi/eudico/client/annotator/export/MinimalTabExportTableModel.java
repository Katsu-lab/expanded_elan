...
/**
    ...
    class MinimalTabExportTableModel {
         ...
         * @param cvEntryMap a map containing controlled vocabulary entries
         */
        ...
        private void initTable() {
            ...
            for (int i = 0; i < annotations.size(); i++) {
                ...
                if (index > -1) {
                    ...
                    row.set(0, curAnn);
                    row.set(1, Long.valueOf(curAnn.getBeginTimeBoundary()));
                    row.set(2, Long.valueOf(curAnn.getEndTimeBoundary()));
...
outerloop: 
         ...
         *
         * @return the ssssssssssssssssssssssssssssssssrows
         */
