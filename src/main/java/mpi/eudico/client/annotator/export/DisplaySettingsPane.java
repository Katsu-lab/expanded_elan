...
/**
 * A dialog to edit the font and color settings for subtitles.
 *
 * @author Aarthy
 * @version 1.0
 */
...
public class DisplaySettingsPane extends JDialog implements ActionListener, ChangeListener{
	    ...
	    /**
	     * Enables/disables the background Color panel
	     *
	     ...
	     *  
	     *  @return a map with stored preferences or {@code null}
	     */
