...
public class JavaSoundPlayer extends ControllerManager implements ElanMediaPlayer, ControllerListener {
	...
	/**
	 * Constructor, currently only the {@code file:/} variant is anticipated.
	 * 
	...
	*/
	...
	public void playInterval(long startTime, long stopTime) {
		if (playerClip != null) {
			...
			syncLock.lock();
			try {
				intervalEndController = new PeriodicUpdateController(10);
...
*/	
	...
	/**
	 * @return the string "JavaSound Media Player"
	 */
	@Override
