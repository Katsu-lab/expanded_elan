...
//		});
    ...
    private void tryHiddenPlayer(String media) {
    	...
    	long timeOut = 1000L;
    	if(FileUtility.isRemoteFile(media)) {
    		timeOut = 3000L;
    	}
        try {
    ...
    /**
     *
     * @return the string "VLCJMediaPlayer-" plus version
     */
    @Override
     ...
     *
     * @param startTime the start time, from time
     * @param stopTime the stop time, to time
     */
    @Override
...
//    			return playerComponent;	
    ...
    /**
     * @return the video height if it has been detected, a fallback height
     * if not
     */
    @Override
    ...
    /**
     * @return the video width if it has been detected, a fallback width if not
     */
    @Override
