 ...
 * Supports a kind of cursor, a rectangle that highlights one cell of a (flexible)
 * grid to indicate the advance of along a virtual timeline. The cursor moves
...
public class ImagePanel extends JPanel implements ComponentListener {
	...
	/**
	 * Sets the number of columns and rows of the cursor grid. 
	 * 
	 ...
	 * 
	 * @param visible if {@code true} the cursor/highlighter will be visible
	 */
	 ...
	 * 
	 * @return the cursor's visibility flag
	 */
