...
//                transcription.setNotifying(true);
	...
	public void execute(Object receiver, Object[] arguments) {
		...
		//Object[] nextArgs = new Object[]{Long.valueOf(aa.getBeginTimeBoundary()), Long.valueOf(aa.getEndTimeBoundary())};
			...
			if (numDescendants > 0) {
				...
				if (checkNode != null) {
					...
					if (numDescendants == numMovedDescendants) {
						...
						LOG.warning("Not all descendent annotations could be moved, therefore the original annotation is copied not moved.");
					}
				}
			} else {
				((TierImpl) aa.getTier()).removeAnnotation(aa);
