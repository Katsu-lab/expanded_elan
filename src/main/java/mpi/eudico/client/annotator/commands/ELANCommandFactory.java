...
public class ELANCommandFactory {
	...
	public static final String NEW_ANNOTATION_FROM_BIGIN_END_TIME_DLG = "Menu.Annotation.NewAnnotationFromBeginEndTimeDialog";
	...
	public static CommandAction getCommandAction(Transcription tr, String caName) {
		...
		if (ca == null) {
			...
			else if(caName.equals(NEW_ANNOTATION_FROM_BIGIN_END_TIME_DLG)) {
	...
	public static Command createCommand(Transcription tr, String cName) {
		...
		else if (cName.equals(NEW_ANNOTATION_FROM_BIGIN_END_TIME_DLG)) {
