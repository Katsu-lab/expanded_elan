...
/**
 * Class to select the tiers for each column and to show or hide the tiers.
 * 
...
public class SelectChildTiersDlg extends ClosableDialog implements ActionListener{
    ...
    /** structure : {@code Map<refTier, List of all linked tiers>} 
     *  the current tierMap of the transcription table
     */
 	private Map<TierImpl, List<TierImpl>> tierMap;
 	
 	/**structure : {@code Map<refTierName, < typeName, List of all tierNames of this type>}  */
 	 ...
 	 * @param tierMap the current tier map of the table, tier to linked tiers mapping
 	 * @param hiddenTiers a list of hidden tiers
 	 * @param columnTypeList a list of tier types
 	 */
    public SelectChildTiersDlg(ElanLayoutManager layoutManager, Map<TierImpl, List<TierImpl>> tierMap, 
    		List<String> hiddenTiers, List<String> columnTypeList){
...
//    	 setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
    ...
    /**
     * Returns a list of tier names of the given type 
     ...
     * the return type. This method returns a list of TierImpl objects.
     * 
     * @param refTier the reference tier (top level tiers)
     * @param type the linguistic type name of the tiers to be returned
