...
public class TranscriptionTableEditBox extends JPanel implements ActionListener,
     ...
     * @param table the table containing the tiers and annotations
     */
     ...
     *
     * @return {@code true} if a CV has to be used, {@code false} otherwise
     */
     ...
     * 
     * @return the text of the editor or {@code null}
     */
    ...
    /**
     * Overrides {@code setFont(Font)} in Component by also setting the font for the
     * text areas.
     *
     ...
     * even if the linguistic type has an associated ControlledVocabulary.
     * 
     * @param ann the annotation to be edited
     * @param forceOpenCV if {@code true} the associated CV will be ignored, 
     ...
     *
     * @return {@code true} if the annotation's value has been edited, 
...
//    		}
    ...
    /**
     * Checks the global preference whether de-selecting edit box commits 
     * the changes.
     * 
     * @return {@code true} if de-selecting commits the changes made so far 
     */
    ...
    /**
      * Merges the given, current annotation with the annotation before it.  
      */
    ...
    /**
     * Merges the given, current annotation with the annotation next to it.
     */
    ...
    /*
     * Switches to Annotation Mode to edit the current annotation, if any.
     */
    ...
    /**
     * Sets up and configures a certain kind of editor component.
     *
     * @param preferredComponent the {@code class} of the preferred editor 
     * component 
     * @param font the font to use
    ...
    /**
     * Makes the {@code editorComponent} visible and tries to grabFocus.<br>
...
//        }	    	
	 ...
	 * given cell.
	 * 
	 * @param ann the annotation in the cell
    ...
    class CVEntryComponent {
        ...
        /**
         * Creates a new entry list and initializes components.<br>
