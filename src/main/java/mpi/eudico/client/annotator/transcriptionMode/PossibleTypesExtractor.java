...
/**
 * A class which extracts a list of possible linguistic types 
...
public class PossibleTypesExtractor{
    ...
    /**
     * Creates a new PossibleTypesExtractor instance.
     * 
     * @param transcription the transcription containing the types and tiers
     */
     ...
     * @param columnTypeList the types selected in the previous column
     * 
