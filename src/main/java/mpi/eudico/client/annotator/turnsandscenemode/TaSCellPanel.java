...
public class TaSCellPanel extends JPanel {
	...
	/**
	 * Starts editing by requesting the focus for the text area.
	 */
	...
	/**
	 * Transfers the focus from the text area up.
	 */
	...
	/**
	 * Sets the selected state of the indicator panel.
	 * 
	 * @param selected if {@code true} a selection background color will be
	 * painted
	 */
	 ...
	 * 
	 * @param font the font to use for rendering (most) texts and labels
	 */
	@Override
	...
	/**
	 * Returns whether the time information label is visible.
	 * 
	 * @return {@code true} if the time labels are set to visible
	 */
	...
	/**
	 * Sets the visibility of the time labels.
	 * 
	 * @param timeLabelVisible if {@code true} the time information labels will
	 * be shown
	 */
	...
	/**
	 * Returns whether the speaker labels are visible.
	 * 
	 * @return {@code true} if the speaker labels are set to be visible
	 */
	...
	/**
	 * Sets the visibility of the speaker labels.
	 * 
	 * @param speakerLabelVisible if {@code true} the speaker labels will be
	 * set to visible
	 */
	...
	/**
	 * Sets several flags for the visibility of decorations.
	 * 
	 * @param inTimeSelection if {@code true} this cell will be marked with a 
	 * selection color it is within the time selection
	 * @param containsCrosshair if {@code true} this cell will show a crosshair
	 * marker if the current media time is inside this cell's interval 
	 * @param isActiveAnnotation if {@code true} the active annotation marker
	 * will be shown if this cell holds the active annotation
	 * @param isActiveGap if {@code true} the active gap marker will be shown
	 * if this cell is the active gap
	 */
	...
	/**
	 * Repaints based on the new media time.
	 * 
	 * @param mediaTime the new media time
	 */
