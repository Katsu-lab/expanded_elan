...
public class TaSActivateCellAction extends AbstractAction {
	...
	/**
	 * Creates a new TaSActivateCellAction instance.
	 * 
	 * @param viewer the target viewer of this action 
	 * @param nextOrPrevious one of {@code SwingConstants#NEXT}, {@code SwingConstants#PREVIOUS}
	 ...
	 * 
	 * @param direction up or down, one of {@code SwingConstants#PREVIOUS} or {@code SwingConstants#NEXT}, 
	 * or cell at current time in case of {@code SwingConstants#CENTER}
	 */
