...
public class PlatformPanel extends AbstractEditPrefsPanel implements PreferenceEditor, ChangeListener {
    ...
    private JCheckBox javfAudioFromVideoCB;
    ...
    private JCheckBox jmmfAudioFromVideoCB;
    private boolean origJMMFAudioExtraction = true;
    // Linux
    ...
    private void initComponents() {        
        ...
        if (SystemReporting.isMacOS()) {
	        ...
	        javfAudioFromVideoCB = new JCheckBox(ElanLocale.getString("PreferencesDialog.Media.AudioExtraction"),
	        		origJAVFAudioExtraction);
	        javfAudioFromVideoCB.setFont(plainFont);
	        ...
	        gbc.gridy = gy++;
	        outerPanel.add(javfAudioFromVideoCB, gbc);
	       ...
	       //media framework	
	        ...
	        jmmfDebugModeCB = new JCheckBox(ElanLocale.getString("PreferencesDialog.Media.Debug"), 
	        		origJMMFDebugMode);
	        jmmfAudioFromVideoCB = new JCheckBox(ElanLocale.getString("PreferencesDialog.Media.AudioExtraction"),
	        		origJMMFAudioExtraction);
        	jfxRB = new JRadioButton(ElanLocale.getString("PreferencesDialog.Media.JFX"));
	        javaSoundRB = new JRadioButton(ElanLocale.getString("PreferencesDialog.Media.JavaSound"));
	        vlcjB = new JRadioButton(ElanLocale.getString("PreferencesDialog.Media.VLCJ"));
	        ...
	        jmmfAudioFromVideoCB.setFont(plainFont);
	        ...
	        gbc.gridy = gy++;
	        outerPanel.add(jmmfAudioFromVideoCB, gbc);
...
//                	}
                ...
                if (javfAudioFromVideoCB.isSelected() != origJAVFAudioExtraction) {
                	chMap.put("NativePlayer.AudioExtraction", Boolean.valueOf(javfAudioFromVideoCB.isSelected()));
                }
        	} else if (SystemReporting.isWindows()) {               
                ...
                if (origJMMFAudioExtraction != jmmfAudioFromVideoCB.isSelected()) {
                	chMap.put("NativePlayer.AudioExtraction", jmmfAudioFromVideoCB.isSelected());
                }
        	} else if (SystemReporting.isLinux()) {
	...
	public boolean isChanged() {
    	if (SystemReporting.isMacOS()) {
    		...
    		if (origJAVFAudioExtraction != javfAudioFromVideoCB.isSelected()) {
    			return true;
    		}
...
//            	}
	...
	public void stateChanged(ChangeEvent ce) {
		if (SystemReporting.isWindows()) {
			...
			//javfAudioFromVideoCB should remain enabled if another framework is selected
		}
	}
}
