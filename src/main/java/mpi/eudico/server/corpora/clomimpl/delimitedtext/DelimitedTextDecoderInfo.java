...
public class DelimitedTextDecoderInfo implements DecoderInfo {
    ...
    /**
     * Returns an array of {@code int} containing the indexes of the columns
     * containing annotations.
     *
     * @return the annotationColumns.
     */
    ...
    /**
     * Sets the indexes of columns containing annotations.
     *
    ...
    /**
     * Returns whether there is only a single annotation on each row or
     * multiple.
     *
     * @return Returns if true there is only one annotation column, otherwise
     *         there are multiple annotations/tier columns
     */
