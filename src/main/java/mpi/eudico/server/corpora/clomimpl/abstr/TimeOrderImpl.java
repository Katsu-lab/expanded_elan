...
public class TimeOrderImpl implements TimeOrder {
     ...
     *
     * @param theTranscription the transcription this {@code TimeOrder} is 
    ...
    /**
     * Removes a {@link TimeSlot} and triggers re-index. 
     *
     * @param theSlot the {@code TimeSlot} to remove
     */
    @Override
    ...
    /**
     * Returns the number of elements of this TimeOrder.
     *
     * @return the size or the number of elements of TimeOrder
     */
    @Override
	public int size() {
    ...
    */
    ...
    /**
     * Calculates a time for an unaligned slot based on the nearest aligned 
     * slots. 
     *
     * @param theSlot the {@code TimeSlot} to calculate a time for
     *
     * @return the calculated time or the time of {@code theSlot} in case it
     *  is an aligned slot
     * @deprecated this is currently only called, theoretically, for top level
     * tiers. But (partially) unaligned annotations on top level tiers are not
     * supported anymore (and never really have been supported). HS 2020
     */
    @Override
    ...
    /**
     * Returns an iterator for the slots currently contained in this time order
     *
     * @return a {@code Iterator<TimeSlot>}
     */  
    @Override
    ...
    /**
     * Changes the time value of the specified slot and moves it to a new
     * position in the order if required.
     *
     * @param theSlot the {@link TimeSlot} to modify
     * @param newTime the new time value for the slot
     */
    @Override
	...
	public void shift(long fromTime, long shift, TimeSlot lastFixedSlot, 
		...
		Iterator<TimeSlot> enum1 = iterator();
