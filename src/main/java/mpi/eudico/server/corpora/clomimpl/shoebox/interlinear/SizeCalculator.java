...
public class SizeCalculator {
     ...
     *        interlinearizing
     * @param g the graphics context providing essential metrics
     */
    ...
    /**
     * Unclear if this is different from the relevant 
     * {@link String#getBytes(java.nio.charset.Charset)} method.
     *
     * @param utf8String source UTF-8 string
     *
    ...
    private static int determineUsedWidth(Annotation ann, Metrics metrics) {
        ...
        // algorithm: add extra width to last of ann's children on each tier.
