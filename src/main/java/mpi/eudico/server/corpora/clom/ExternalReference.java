...
public interface ExternalReference extends Cloneable, Serializable {
    ...
    /**
     * @return a string representation of the type of the external reference object.
     */
     ...
     *
     * @throws CloneNotSupportedException if an implementing class can not support cloning
     */
